<%@ Page Title="" Language="C#" MasterPageFile="~/Patient.Master" AutoEventWireup="true" CodeBehind="PatientReport.aspx.cs" Inherits="SHCAMS_Web.PatientReport" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <tr>
        <td class="auto-style2" colspan="4"><strong>REPORTS</strong></td>
    </tr>
    <tr>
        <td colspan="4">
